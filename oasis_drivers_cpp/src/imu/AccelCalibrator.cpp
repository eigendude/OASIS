...
void AccelCalibrator::OnlineStats::UpdateWinsor(double x, double alpha, double sigma_floor,
                                                double k_clip)
{
...
bool AccelCalibrator::UpdateStationaryDwell(bool stationary_candidate, bool use_leaky,
                                            double dt_seconds)
{
                                                     ...
                                                     double dt_seconds)
{
  ...
  const double dt_clamped = std::clamp(dt_seconds, kStationaryFallbackDtSeconds,
                                       kStationaryMaxDtSeconds);
