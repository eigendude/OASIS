...
constexpr double DEFAULT_LINEAR_ACCELERATION_RATE_HZ = 100.0;
constexpr double DEFAULT_GRAVITY_RATE_HZ = 25.0;
constexpr double DEFAULT_ROTATION_VECTOR_BATCH_MS = 0.0;
constexpr double DEFAULT_GYRO_BATCH_MS = 0.0;
constexpr double DEFAULT_ACCELEROMETER_BATCH_MS = 0.0;
constexpr double DEFAULT_LINEAR_ACCELERATION_BATCH_MS = 0.0;
constexpr double DEFAULT_GRAVITY_BATCH_MS = 0.0;
