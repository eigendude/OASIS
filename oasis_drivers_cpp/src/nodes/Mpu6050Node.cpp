...
void Mpu6050Node::PublishImu()
{
  ...
  // Process motion for both imu_raw (sensor measurements) and imu (calibrated
  // stream for ORB-SLAM3). Acceleration retains gravity because ORB-SLAM3
  // expects specific force.
  ...
  auto fillImuMsg = [&](sensor_msgs::msg::Imu& imuMsg,
                        const IMU::Mpu6050ImuProcessor::ImuSample& sample)
  {
