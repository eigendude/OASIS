...
class AhrsParams:
    ...
    def from_dict(cls, params: Mapping[str, object]) -> AhrsParams:
        ...
        unknown_keys: list[str] = sorted(
            set(params.keys()) - set(cls._field_order())
        )
        if unknown_keys:
        ...
        return cls(
            ...
            ε_wall_future_ns=cls._as_int(
                "ε_wall_future_ns",
                params.get("ε_wall_future_ns", defaults.ε_wall_future_ns),
            ),
            Δt_clock_jump_max_ns=cls._as_int(
                "Δt_clock_jump_max_ns",
                params.get("Δt_clock_jump_max_ns", defaults.Δt_clock_jump_max_ns),
            ),
            Δt_imu_max_ns=cls._as_int(
                "Δt_imu_max_ns",
                params.get("Δt_imu_max_ns", defaults.Δt_imu_max_ns),
            ),
