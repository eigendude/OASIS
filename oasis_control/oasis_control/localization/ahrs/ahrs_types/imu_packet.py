...
class ImuPacket:
    ...
    Responsibility:
        Document the IMU measurement fields required by the AHRS filter
    ...
    Data contract:
        ...
        - calibration_meta: metadata for calibration source, validity, and
          change detection.
    ...
    Determinism and edge cases:
        ...
        - After initialization, calibration payload does not modify in-state
          parameters, but calibration_meta should be retained for
          change-detection diagnostics and future reset/re-init policy hooks.
        - Hash contract for calibration_meta:
            - Hash/fingerprint is deterministic for identical calibration
              content.
            - Hash excludes nondeterministic fields (e.g., receipt time).
            - Algorithm is TODO, but the determinism contract is required.
