...
class StationaryModel:
    ...
    def predict_zupt(self, state: AhrsState) -> Sequence[float]:
        pass
    ...
    def jacobian_zupt(self, state: AhrsState) -> Sequence[Sequence[float]]:
        pass

    def predict_no_turn(self, state: AhrsState) -> Sequence[float]:
        pass
    ...
    def jacobian_no_turn(self, state: AhrsState) -> Sequence[Sequence[float]]:
        pass
