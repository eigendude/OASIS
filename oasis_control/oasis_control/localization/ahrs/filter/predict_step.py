...
class PredictStep:
    ...
    Data contract:
        ...
        - Δt_ns is a positive integer nanoseconds time step.
    ...
    Determinism and edge cases:
        ...
        - Δt_ns <= 0 should result in a no-op or a rejected step.
    ...
    Suggested unit tests:
        - Δt_ns=0 leaves state unchanged.
