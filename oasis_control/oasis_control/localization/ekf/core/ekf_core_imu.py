...
class _EkfCoreImuMixin:
    ...
    def _propagate_with_imu(
        ...
        try:
            ...
            # does not accumulate per-substep values
            #
            # Without Phi/G weighting, summing per-step Q is not equivalent to
            # the closed-form dt^4 / 4, dt^3 / 2, dt^2 terms
            #
