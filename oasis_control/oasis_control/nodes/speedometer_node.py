...
from oasis_control.src.speedometer.velocity_estimator import SpeedometerEstimator
...
class SpeedometerNode(rclpy.node.Node):
    def __init__(self) -> None:
        ...
        self._estimator = SpeedometerEstimator(gravity_mps2=self._gravity_mps2)
    ...
    def _handle_imu(self, message: Imu) -> None:
        ...
        if self._frame_id:
            twist_message.header.frame_id = self._frame_id
        else:
