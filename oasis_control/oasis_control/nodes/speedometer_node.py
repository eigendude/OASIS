...
class SpeedometerNode(rclpy.node.Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter(PARAM_ZERO_VELOCITY_COUNT, DEFAULT_ZERO_VELOCITY_COUNT)
        self.declare_parameter(PARAM_ZERO_VELOCITY_ALPHA, DEFAULT_ZERO_VELOCITY_ALPHA)
        self.declare_parameter(PARAM_ZERO_VELOCITY_CLAMP, DEFAULT_ZERO_VELOCITY_CLAMP)

        self._frame_id: str = str(self.get_parameter(PARAM_FRAME_ID).value)
        publish_rate_hz: float = float(self.get_parameter(PARAM_PUBLISH_RATE_HZ).value)
    ...
    def _handle_imu(self, message: ImuMsg) -> None:
        ...
        message_out: TwistWithCovarianceStamped = self._twist_message(message, estimate)
        self._twist_pub.publish(message_out)
    ...
    def _twist_message(
        self, imu_message: ImuMsg, estimate: SpeedEstimate
