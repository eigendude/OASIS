...
class ForwardTwistNode(rclpy.node.Node):
    ...
    def _compute_status_text(self) -> str:
        ...
        return (
            ...
            f"candidate_residual={latest_estimate.learning_state.candidate_residual:.3f}, "
            f"committed_residual={latest_estimate.learning_state.committed_residual:.3f}, "
            f"candidate_unc={latest_estimate.learning_state.candidate_uncertainty_forward_yaw_rad:.3f}, "
            f"committed_unc={latest_estimate.learning_state.committed_uncertainty_forward_yaw_rad:.3f}, "
            f"motion_stability={latest_estimate.learning_state.candidate_recent_stability:.3f}, "
            f"motion_dir=({latest_estimate.learning_state.candidate_motion_direction_xy[0]:.3f},"
            f"{latest_estimate.learning_state.candidate_motion_direction_xy[1]:.3f}), "
            f"motion_proxy=({latest_estimate.learning_state.motion_proxy_velocity_xy[0]:.3f},"
            f"{latest_estimate.learning_state.motion_proxy_velocity_xy[1]:.3f}), "
            f"motion_proxy_speed={latest_estimate.learning_state.motion_proxy_speed_mps:.3f}, "
