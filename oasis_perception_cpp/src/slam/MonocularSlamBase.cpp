...
void MonocularSlamBase::OnInitialized()
{
}

void MonocularSlamBase::OnDeinitialized()
{
}

void MonocularSlamBase::OnPostTrack()
{
}
...
void MonocularSlamBase::MapPublisherLoop()
{
  while (true)
  {
    MapRenderTask task;
    {
      ...
      m_renderCv.wait(lock, [this] { return !m_renderThreadRunning.load() || !m_renderQueue.empty(); });
