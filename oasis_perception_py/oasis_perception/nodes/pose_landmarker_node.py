...
class PoseLandmarkerNode(rclpy.node.Node):
    def __init__(self) -> None:
        ...
        self._image_sub = ImageTransport(self.get_name(), image_transport="compressed")
        self._image_sub.subscribe("/oasis/station/image_raw", 10, self._image_callback)
        ...
        self._pub = self._image_pub.advertise("/oasis/station/pose_landmarks", 10)
