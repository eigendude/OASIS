...
def add_background_subtractor(ld: LaunchDescription, zone_id: str) -> None:
    node: Node = Node(
        namespace=ROS_NAMESPACE,
        package=CPP_PACKAGE_NAME,
...
def add_background_subtractors(
    ld: LaunchDescription, host_id: str, zone_ids: List[str]
) -> None:
    background_container: ComposableNodeContainer = ComposableNodeContainer(
        namespace=ROS_NAMESPACE,
        name=f"background_subtractor_container_{host_id}",
        package="rclcpp_components",
        executable="component_container_mt",
        output="screen",
        composable_node_descriptions=[
...
def generate_launch_description() -> LaunchDescription:
    ...
    if PERCEPTION_SERVER_BACKGROUND:
        add_background_subtractors(ld, HOST_ID, PERCEPTION_SERVER_BACKGROUND)
