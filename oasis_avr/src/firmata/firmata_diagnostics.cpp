...
// Threading constants
constexpr size_t DIAGNOSTICS_STACK_SIZE = 96; // Default is 128

} // namespace OASIS

void FirmataDiagnostics::Setup(void (*loopFunc)())
{
  Scheduler.startLoop(loopFunc, DIAGNOSTICS_STACK_SIZE);
}

void FirmataDiagnostics::Reset()
{
  m_reportPeriodMs = 0;
}

void FirmataDiagnostics::Loop()
{
