...
// Instance storage
HeartbeatTask heartbeatInstance;
...
HeartbeatTask& HeartbeatTask::GetInstance()
{
...
void HeartbeatTask::SetPhase(unsigned int phase, unsigned long now)
{
...
void HeartbeatTask::HeartbeatLoop()
{
  GetInstance().Loop();
}
